...
class SnapshotsControllerTest < ActionController::TestCase
  ...
  test "should create snapshot" do
    assert_difference('Snapshot.count') do
      post :create, snapshot: { description: @snapshot.description, file: @snapshot.file, name: @snapshot.name, video_id: @snapshot.video_id }
    end
  ...
  test "should update snapshot" do
    patch :update, id: @snapshot, snapshot: { description: @snapshot.description, file: @snapshot.file, name: @snapshot.name, video_id: @snapshot.video_id }
    assert_redirected_to snapshot_path(assigns(:snapshot))
  end
